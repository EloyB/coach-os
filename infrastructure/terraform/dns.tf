...
# Public key generated by Google Workspace Admin (apps.google.com/admin →
# Apps → Gmail → Authenticate email). Selector "google" is the default Google
# uses; coexists with the TEM DKIM above because they live on different
# selectors (google._domainkey vs <tem-uuid>._domainkey).
# After this record is live, click "Start authentication" in Workspace Admin
# to flip the status from "Not authenticating email" to authenticating.

resource "scaleway_domain_record" "google_dkim" {
  dns_zone = var.domain_name
  name     = "google._domainkey"
  type     = "TXT"
  data     = "v=DKIM1;k=rsa;p="
  ttl      = 3600
}
