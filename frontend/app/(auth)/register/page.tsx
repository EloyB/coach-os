...
// Self-registration is disabled in production. The original sign-up form is kept
// commented out below so it can be restored when registration is re-enabled.
