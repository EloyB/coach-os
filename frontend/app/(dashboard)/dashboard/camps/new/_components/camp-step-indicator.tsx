...
export function CampStepIndicator({ currentStep }: { currentStep: 1 | 2 | 3 }) {
  const t = useTranslations("camps");

  const steps = [
    { number: 1 as const, label: t("wizardStep1") },
    { number: 2 as const, label: t("wizardStep2") },
    { number: 3 as const, label: t("wizardStep3") },
  ];
