        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonSeries_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EnrollmentForms_LessonSeries_LessonSerieId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    LessonSerieId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_LessonSeries_LessonSerieId",
                        column: x => x.LessonSerieId,
                        principalTable: "LessonSeries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentEmail = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_LessonSeries_LessonSerieId",
                        column: x => x.LessonSerieId,
                        principalTable: "LessonSeries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    MolliePaymentId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    MollieCheckoutUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnrollmentForms_LessonSerieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_LessonSerieId",
                table: "Enrollments",
                column: "LessonSerieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_OrganizationId_Date",
                table: "Lessons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSeries_OrganizationId",
                table: "LessonSeries",
                column: "OrganizationId");
